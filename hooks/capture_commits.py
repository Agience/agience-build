...
from mantle_common import store_artifact, workspace_root  # noqa: E402
...
#: machine-specific literal is not allowed to come back.
_ROOT = workspace_root()
DEFAULT_REPOS = [str(_ROOT / n) for n in
                 ("agience-mantle", "agience-origin", "agience-cloud", "agience-pharos")] if _ROOT else []
